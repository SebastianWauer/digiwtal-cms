    ...
    <section class="surface">
        ...
        <form method="POST" action="/admin/customers" class="form-stack">
            ...
            <div class="form-grid form-grid--2">
                ...
                <div class="field">
                    ...
                    <select class="select" id="abo_status" name="abo_status">
                        <?php
                        $currentAbo = (string)($old['aboStatus'] ?? $old['abo_status'] ?? 'active');
            ...
            <div class="field">
                ...
                <input class="input" type="date" id="abo_active_until" name="abo_active_until" value="<?php echo htmlspecialchars((string)($old['aboActiveUntil'] ?? $old['abo_active_until'] ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
