    ...
    <section class="surface">
        ...
        <form method="POST" action="/admin/customers/<?php echo (int)($customer['id'] ?? 0); ?>/access" class="form-stack">
            ...
            <div class="field">
                ...
                <div class="field__hint">Öffentliche CMS-URL, ohne <code>/api.php</code>. Bei derselben Domain wie das Frontend und einem Unterpfad wie <code>/cms</code> richtet der Deploy diese Pfadanbindung automatisch ein.</div>
            </div>
