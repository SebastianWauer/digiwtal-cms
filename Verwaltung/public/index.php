...
$dashboardController      = new DashboardController($customerRepo, $healthMonitor);
...
$ciTokenController        = new CiTokenController($ciTokenRepo, $customerRepo, $accessRepo, $auditLogger, $healthMonitor);
...
$router->add('GET',  '/admin/migrations', [$migrationController, 'index']);
...
$router->add('POST', '/admin/support/zugang/{id}', [$supportController, 'zugang']);
...
$router->add('POST', '/admin/ci/dispatch', [$ciTokenController, 'dispatchAll']);
